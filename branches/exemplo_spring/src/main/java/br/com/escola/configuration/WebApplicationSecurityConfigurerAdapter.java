...
//  hasAnyRole("ROOT", "ADMIN")
		http.authorizeRequests().antMatchers("/aluno.jsf")
	...
	/*@Bean
	public InMemoryUserDetailsManager inMemoryUserDetailsManager(Map<String, String> usersAut) {
		for (Entry<String, String> entry : usersAut.entrySet()) {
			System.out.println(entry.getKey());
			System.out.println(entry.getValue());
			//chave.encode("123")+", ROOT, enabled"
